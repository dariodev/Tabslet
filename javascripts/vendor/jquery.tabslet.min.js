 ...
 * @version   v1.7.3
 *
 * Added tabSelector option - by dariodev
 *
 */
...
(function($, window, undefined) {
    ...
    $.fn.tabslet = function(options) {
        ...
        return this.each(function() {
            ...
            // Autorotate
            var elements = $this.find(options.tabSelector),
            ...
            if (!$this.data('tabslet-init')) {
                ...
                _tabs.hide().removeClass("active--tab");

                if ($this.opts.active) {
                    _tabs.eq($this.opts.active - 1).show().addClass("active--tab");
                ...
                var fn = eval(
                    ...
                    function(e, tab) {
                        ...
                        if ($this.opts.animation) {
                            ...
                            _container.find(currentTab).show().addClass("active--tab");
                            _this.trigger('_after');
                ...
                $this.on('destroy', function() {
                    ...
                    _tabs.each(function(i) {
                        ...
                        $(this).removeAttr('display', _cache_div[i]);
                    });
                });
